  ...
  async processData(data) {
    try {
      ...
      if (totalConsumedT1 !== undefined) {
        this.setCapabilityValue('meter_consumed_t1', Number(totalConsumedT1)).catch(this.error);
      }
      if (totalConsumedT2 !== undefined) {
        this.setCapabilityValue('meter_consumed_t2', Number(totalConsumedT2)).catch(this.error);
      }
      if (totalProducedT1 !== undefined) {
        this.setCapabilityValue('meter_produced_t1', Number(totalProducedT1)).catch(this.error);
      }
      if (totalProducedT2 !== undefined) {
        this.setCapabilityValue('meter_produced_t2', Number(totalProducedT2)).catch(this.error);
      }
